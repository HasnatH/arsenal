...
class Find_Model extends CI_Model
{
	...
	//this search function is for users who are not logged in and sends back the relevant info
	//the select data is limited here 
	...
	//search for HR who is logged in
	//more data sent
	...
	//'delete' from Dept_Emp table (edit the to_date to '9999-01-01')
	...
	//'delete' from Dept_Manager table (edit the to_date to '9999-01-01')
	...
	//'delete' from Salaries table (edit the to_date to '9999-01-01')
	...
	//'delete' from Title table (edit the to_date to '9999-01-01')
	...
	public function retrieve($emp_no)
	{
		...
		//get the current salary of the employee - the most recent record where it states 'to_date' = '9999-01-01'
	function currentSalary($emp_no)
	{
		...
		//get the current title of the employee - the most recent record where it states 'to_date' = '9999-01-01'
	...
	function currentTitle($emp_no)
	{
		...
		return $retr;
			...
			//get the current department of the employee - the most recent record where it states 'to_date' = '9999-01-01'
	...
	//**NOT USED**
	//test search query depending on what they sent
